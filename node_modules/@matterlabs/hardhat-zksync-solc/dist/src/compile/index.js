...
async function compile(zksolcConfig, input) {
...
class BinaryCompiler {
    static async initialize() {
        (0, binary_1.checkZksolcBinary)();
        return new BinaryCompiler();
    }
    async compile(input, config) {
        return await (0, binary_1.compileWithBinary)(input, config);
    }
}
...
class DockerCompiler {
    ...
    static async initialize(config) {
        ...
        const image = (0, docker_1.dockerImage)((_a = config.settings.experimental) === null || _a === void 0 ? void 0 : _a.dockerImage);
